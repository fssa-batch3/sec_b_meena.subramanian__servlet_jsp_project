...
<body>
	...
	<div class="navigations">
		...
		<div class="navigations">
			...
			<div class="order">
				<a href="<%=request.getContextPath()%>/pages/orders/my orders.jsp"><i
					class="fa fa-shopping-bag" style="font-size: 22px; color: black;"></i></a>
			</div>
			<div class="favorite">
				<a href="<%=request.getContextPath()%>/pages/whislist/wishlist.jsp"><i
					class="fa fa-heart" style="font-size: 22px; color: black;"></i></a>
			</div>
		</div>
