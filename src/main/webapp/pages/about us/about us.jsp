...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="<%= request.getContextPath() %>/assets/css/about us.css">
...
<jsp:include page="/header.jsp" />
        ...
        <section class="about-1">
            <div class="about-us">
                <h4>The History Of Handloom</h4>
                <p>In the olden times, people actively used charkha for spinning cotton to make it a fabric. In each and every village of India, a separate weavers community was present which produced Handwoven and Handspun fabrics from small instruments like Charkhas. But due to British rule, many things turned upside down for the handloom sector of our country. </p>
            </div>

            <div class="vidios">
                <div class="video">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/AJYaQswa4Cs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
        
                <dvi class="vido-content">
                    <p>A ‘handloom’ is a loom that is used to weave cloth without the use of any electricity. Hand weaving is done on pit looms or frame looms generally located in weavers’ homes. Weaving is primarily the interlacing of two sets of yarn – the warp (length) and the weft (width). The equipment that facilitates this interlacing is the loom.</p> 
                </dvi>
            </div>

            <div class="chemical">
                <h3>Advantages of handloom cotton</h3>
                <p>The handloom experience (soft, comfortable and durable) is due to the human handling of the yarn in the weaving process. As a result, yarn and the fabric are much less stressed and damaged. Hand woven cotton is known for its breathability as compared to mill made cotton. This implies that it allows more air penetration making it cooler, softer and more absorbent. It keeps you cooler in summers and warm in winters.
                </p>
            </div>
            ...
            <div class="yarns">
                <div class="yarn">
                    <h4>Hank yarn</h4>
                    <img src="../../assets/img/yarn.png" alt="photo">
                </div>

                <div class="yarn-content">
                    <p>Yarn, in the hank form, is used typically in handlooms. A “hank” is a specific length of yarn that is in a coiled form. A hank of cotton yarn is 840 yards long. Hank yarn is used in handloom production as opposed to cone yarn, which is used in mill production.</p>
                </div>
            </div>
            ...
            <div class="Hand">
                ...
                <div class="drying-content">
                    <p>Natural dyes are dyes that are extracted from bark of trees, insects, flowers, minerals, rust and other natural materials. Vegetable dyes are a sub-category of natural dyes referring to those that come from plant matter only. Wool is generally the best fiber to color with natural dyes. It will attach to a wider variety of dye chemicals than cellulose fibers such as cotton, and, since it is usually washed in cool water, or only dry-cleaned, the relative impermanence of most natural dyes is less of an issue.
                        ...
                        Synthetic fibers usually cannot be dyed with natural dyes.</p>
                </div>
            </div>
            ...
            <div class="Hand">
                <div class="drying">
                    <h4>Indigo dyeing</h4>
                    <img src="../../assets/img/kyh-indigo-dyeing.png" alt="photo">
                </div>

                <div class="drying-content">
                    <p>
                        Indigo dyeing was one of the first specialty professions in manufacturing of textiles. It contains neither harsh chemicals nor toxic metals. It can be used to dye any natural fibre. The use of indigo dyeing goes back to 2000B.C<br>
                        <br>

                        Indigo is a dye different than any other. First step in the process “reduces” the indigo, changing it from blue to yellow. When the yarn is worked in the solution, or “vat” and brought out to the air, it is a bright green. Slowly the air changes it to the beautiful deep and rich blue of Indigo. Indigo in some form was used in all traditional cultures, for it is the only clear and fast natural blue..</p>
                </div>
            </div>
            ...
            <div class="Hand">
                <div class="drying">
                    <h4>Warping</h4>
                    <img src="../../assets/img/kyh-warping.png" alt="photo">
                </div>

                <div class="warping-content">
                    <p>Warping is a process, which converts the hank yarn into a linear form to give the length on the loom. Warping is done on a huge drum and the width and desired quality of the product is decided at this stage. The drum also helps to calculate number of threads and the length of the warp.</p>
                </div>
            </div>
            ...
            <div class="Hand">
                <div class="drying">
                    <h4>Street sizing</h4>
                    <img src="../../assets/img/kyh-sizing.png" alt="photo">
                </div>

                <div class="drying-content">
                    <p>After warping is done, the warp is stretched out and sizing material is applied to add strength to the yarn and lubricate it to withstand the rigors of weaving. Natural adhesives like rice, maize, wheat flour or potato starch are used depending upon the availability and region. In most handloom centers rice starch / gruel is mixed with coconut / groundnut oil and applied as sizing material.This activity of starching the yarn for weaving is known as “sizing”. This starch in the yarn is removed only after two to three washes of the woven product. Sizing process is only done on single count yarn, which is woven on pit looms.

                        Sizing is either carried out by the weavers or by skilled groups in the village. . Since this activity is carried out on the street, this is referred to as “street sizing”.</p>
                </div>
            </div>
            ...
            <div class="Hand">
                <div class="drying">
                    <h4>Loom</h4>
                    <img src="../../assets/img/kyh-pit-loom.png" alt="photo">
                </div>

                <div class="drying-content">
                    <p>Pit loom, stand loom and frame loom are three kinds of looms predominantly used by handloom weavers. The Pit loom is a loom situated on the ground / floor with a pit having two peddles set in the pit for the weaver to operate. Pit loom weaving is considered to be better weaving as the fabric woven retains the character of the fiber and fabric due to the proximity to the ground. The ground absorbs the tension and speed and makes the fabric more breathable.</p>
                </div>

                <div class="looming">
                    <img src="../../assets/img/kyh-loom.png" alt="img">
                </div>
            </div>

            <div class="chemical">
                <h3>Weaving techniques</h3>
                <p>
                    Different techniques are used for weaving on the loom. There is a basic weaving technique which makes the fabric. There are others, which are used to create surface designs on the fabric.<br>
                    <br>

                    Plain weave is the most commonly used technique to weave fabric on pit looms. Design and variety in fabric woven with plain weave is created through texture, stripe and check. Texture is created by using different thicknesses of yarns. Stripes and checks are created by colour or by using different thicknesses in yarn.<br>
                    <br>
        
                    Extra warp and weft techniques are also used to create designs / surface patterns on the fabric. Traditionally, borders were used in sarees and dhoties and most of the looms wove petu, a dobby technique with aextra warp for creating patterns in the borders.<br>
                    <br>
                </p>
            </div>
            ...
            <div class="Hand">
                <div class="drying">
                    <h4>Weft</h4>
                    <img src="../../assets/img/kyh-weft.png" alt="photo">
                </div>

                <div class="weft-content">
                    <p>Weft in a fabric is yarn which passes across the fabric width. Weft yarn is passed through the warp yarn to create the fabric</p>
                </div>
            </div>
            ...
            <div class="Hand">
                <div class="drying">
                    <h4>Khadi fabric</h4>
                    <img src="../../assets/img/kyh-khadi.png" alt="photo">
                </div>

                <div class="drying-content">
                    <p>
                        Khadi fabric is woven mostly in KVIC (Khadi Village Industries Commission) institutions located in villages across the country. Yarn is spun by hand and fabric is woven using this yarn on a handloom in these institutions. Most of the Khadi production is sold through KVIC outlets. Few individual organizations buy these fabrics from Khadi institutions and sell from their outlets.<br>
                        <br>

                        The weavers mostly weave from their homes, at times from centres established by the institutions. Ensuring that these institutions make Khadi fabric is one of the mandates of KVIC management</p>
                </div>
            </div>

            <div class="chemical">
                <h3>Different perceptions of handloom</h3>
                <p>
                    Handloom weaving and products have been amongst us for many centuries. In the last few decades, the distance and disconnect between the customer and weaver has increased tremendously, resulting in a many perceptions among customers today which might not be completely true.<br>
                    <br>

                    One of the main perceptions is that all cottons are woven on handlooms. This is not true, as a large amount of cotton fabric production is carried out by power looms and large mills. Most of the cotton garments available in the mainstream market are not made from hand woven fabric.<br>
                    <br>
