...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="../../assets/css/product list dothi.css">
                ...
                <div class="footer-2">
                    ...
                    <div class="icons">
                        ...
                        <a href="https://in.linkedin.com/">
                            <img src="../../assets/img/linkedin-2950130-2447889.webp"
                                alt="photo" width="50px"></a>
                        <a href="https://github.com/">
                            <img src="../../assets/img/github-2950150-2447911.webp" alt="photo"
                                width="50px"></a>
                        <a href="https://www.instagram.com">
                            <img src="../../assets/img/insta.webp" alt="photo"
                                width="50px"></a>
                        <a href="https://web.telegram.org/k/">
                            <img class="tele" src="../../assets/img/tele.webp" alt="photo"
                                width="40px" style="margin-bottom: 40px; margin-left: 3px;"></a>
...
for (let i = 0; i < add_products.length; i++) {
  if (add_products[i].productreview === "Dhoti") {
    //    <div class=wat> </div>
